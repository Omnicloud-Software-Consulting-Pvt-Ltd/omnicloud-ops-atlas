...
import PillarPeople from "@/app/components/PillarPeople";
...
export default async function PillarPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="mx-auto flex max-w-[1140px] items-start gap-8 px-8 py-10 max-md:px-5 max-md:py-6">
